...
## Assign the column with name the new table of the total FATALITIES and INJURIES combined.
names(totalEconomic) <- c("EVENT TYPE", "Total Crop & Property Damage in $Million")
```
...
economicImpactRank <- economicImpact[order(-economicImpact$'Total Crop & Property Damage'), ]
...
#### 1. Across the United States, which types of events are most harmful with respect to population health?
**ANS: **
** The following table will show you the top 10 health impact per event type **
