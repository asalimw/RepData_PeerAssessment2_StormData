...
Thirdly to solve the question on economic impact there are four variables that we need to analyse namely 

```{r, DownloadingData, cache =TRUE}
## Download data from the link provided in the sypnosis and read csv bz2 file and assign it to variable data.
...
## Look at the total number of observations and variables whether it is the same as the Week 4 Forum discussion
str(data)
```
