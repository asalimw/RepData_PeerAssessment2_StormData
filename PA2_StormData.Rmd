...
#### Part 3:
- Use the Aggregate and CBIND function to get the total number of CROPDMGEXP, CROPDMG, PROPDMGEXP and PROPDMG based on the EVTYPE. 
```{r, ProcessCropPropertiesDAMAGESEXP, cache = TRUE}

expData <- data[data$PROPDMGEXP %in% c("", "K", "M", "B") & data$CROPDMGEXP %in% c("", "K", "M", "B"), ]
...
expData$PROP_DMG <- mapply(convExponent, expData$PROPDMG, expData$PROPDMGEXP)/1000000
expData$CROP_DMG <- mapply(convExponent, expData$CROPDMG, expData$CROPDMGEXP)/1000000
